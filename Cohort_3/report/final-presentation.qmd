...
::: footer
Learn more: [TOPC Partners](https://www.centreforpublicimpact.org/north-america/government-innovation/the-opportunity-project-for-cities-topcities)
:::

## Executive Summary

**💡 Curriculum design and content:** To develop higher critical thinking skills across varying expertise levels, adapt the program with specialized tracks for new learners and advanced practitioners.

**💡 Programmatic processes and operations:** To prevent skill and interest plateauing and foster continuous professional advancement, expand the curriculum with advanced HCD modules alongside a city maturity model.

**💡** **Collaboration and communication:** To better align with participants' pre-existing knowledge, reduce project timelines pressures, and increase early team collaboration, refine the program design to introduce adaptive pacing and provide a roadmap for expected collaboration.
...
-   **Ongoing feedback** with an Insights Log of testimonials form throughout the design sprint.
...
The *pre-test* survey had a total of respondents from:
...
The *post-test* survey had a total of respondents from:
...
![](images/q4_pre_frequency_plot-01.png){fig-align="center" width="100%"}
:::

::: {.column width="50%"}
**After**

![](images/q3_post_frequency_plot.png){fig-align="center" width="100%"}
:::
:::

Weights were applied in this survey analysis to adjust the results to compensate for different probabilities of selection, non-response, and to adjust the sample to known population totals.
...
Self-efficacy is measured against two types of skills:
...
Overall, the survey results show a **positive shift** in participant's agreement that they learned new skills across key learning areas of community research and product stewardship.

However, open-ended survey question provide interesting context that could either **contradict** their initial responses or **provide more nuances**. For example, a participant might have indicated they learned in general on community research but reported in open-ended questions that they found program content redundant because they already collaborate with community partners in their work.
:::

Relevant quotes:

*"I am **already familiar** with the design thinking process so some of the instructional meetings were not relevant to me." -* Senior Official

------------------------------------------------------------------------

Relevant quotes:

*"Some of the **content training was a repeat** from our previous sprint. It was good to have a refresher, but was **not as helpful** as the other aspects."* - Manager

*"I appreciate the **idea of a "sprint"** and getting things done on a timeline, however this made the project even more **difficult at times**. There was **not much room** for setbacks and this often created pressure within the team. Also, **meeting** once a week was needed because of the timeline, but this can be **overwhelming** at times in collaboration with other obligations."* - Community Leader
...
Oerall, the survey results show a **positive shift** in participant's agreement that they learned new skills in the partnership key learning area.

However, open-ended survey question provide **context about participant needs.** General needs are early collaboration with tech vendors, community partners, and internal stakeholders, bringing technical expertise sooner than later, and meeting in-person.
:::

Relevant quotes:

*"Making sure we have the **commitment** of all **internal partners** that need to be involved and that meeting invites were sent out to those key partners **ahead of time**."* - Senior Official

*"More opportunities to meet **in person**."* - Civil Servant

------------------------------------------------------------------------

Relevant quotes:

*"Not changing coaches. simplifying the idea. Having the **technical team** produce a prototype earlier for us to review and improve it."* - Senior Official

*"I think having the co**mmunity partner** in the **initial meeting** with the city to discuss the problem statement could have been ideal. This would've **helped flesh** out the **problem statement** especially because the community partner may have different insight on what issues residents are facing."* - Community Leader

*"I would strongly suggest to **bring more tech people** into this Sprint. It will help us **gain more ideas** from technology perspective."* - Manager
...
Overall, the survey results show a **positive agreement** in participant's recommending this program to their peers across all cities.

However, open-ended survey question provide **context about participant needs.** General needs are early collaboration with key partners including leadership buy-in, more in-person collaboration, improvements in the program's processes like meetings and timelines, and content.
:::

------------------------------------------------------------------------

#### 5. Participant intention to action
...
Future iterations will incorporate such queries to gauge participant willingness to apply skills gained in the program to future or existing work.
...
-   **Process management** encountered bureaucratic hurdles and the pressure of the sprint timeline.
...
Supporting quotes from interviews: *"A reassessment of the **rigidity of the formula** that that it comes with versus kind of being flexible to what is what is coming in."* - Detroit
...
It should also introduce mechanisms and practical approaches for **early team collaboration** with community and tech partners and **navigate bureaucratic processes** more smoothly. Build in more timeline flexibility to **account for setbacks.** Evaluate and refresh the curriculum regularly, considering participants' feedback to ensure relevance and engagement.
:::
...
-   [Github repository](https://github.com/beeckcenter/TOPC-impact-evaluation-dashboard "TOPC impact evaluation dashboard")

-   [Survey data](https://drive.google.com/drive/folders/1Awynlxerr_mH0LjnwfzvV6PM44rPP5A0?usp=drive_link)

-   [Interview data](https://drive.google.com/drive/folders/1Awynlxerr_mH0LjnwfzvV6PM44rPP5A0?usp=drive_link)
