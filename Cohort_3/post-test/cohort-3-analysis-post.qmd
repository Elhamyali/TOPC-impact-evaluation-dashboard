...
q3_post_frequency_plot <- ggplot(as.data.frame(q3_frequency), aes(x = q3, y = Freq)) +
  geom_bar(stat = "identity", fill = "#041e42", width = 0.7) +
  coord_flip() +
  expand_limits(y = c(0, total_sample)) + 
  labs(title = "Q3. Which city/county are you representing?",
...
print(q3_post_frequency_plot)
ggsave("plots/q3_post_frequency_plot.png", q3_post_frequency_plot)
```
...
q25_post_frequency_plot <- ggplot(as.data.frame(q25_frequency), aes(x = q25, y = Freq)) +
  geom_bar(stat = "identity", fill = "#041e42", width = 0.7) +
  coord_flip() +
  expand_limits(y = c(0, total_sample)) + 
  labs(title = "Q25. Which title best describes your role and level of 
seniority at work?",
...
print(q25_post_frequency_plot)
ggsave("plots/q25_post_frequency_plot.png", q25_post_frequency_plot)
```
...
q27_post_frequency_plot <-ggplot(as.data.frame(q27_frequency), aes(x = q27, y = Freq)) +
  geom_bar(stat = "identity", fill = "#041e42", width = 0.7) +
  coord_flip() +
  expand_limits(y = c(0, total_sample)) + 
  labs(title = "Q27. How many years have you worked at your respective City or County?",
       subtitle = paste("Total number of survey respondents (n =", total_sample, ")"),
       x = "",
       y = "Number of Responses") +
  theme_minimal() + 
...
print(q27_post_frequency_plot)
ggsave("plots/q27_post_frequency_plot.png", q27_post_frequency_plot)
```
...
q28_post_frequency_plot <-ggplot(as.data.frame(q28_frequency), aes(x = q28, y = Freq)) +
  geom_bar(stat = "identity", fill = "#041e42", width = 0.7) +
  coord_flip() +
  expand_limits(y = c(0, total_sample)) + 
  labs(title = "Q28. Please describe your racial/ethnic identity.",
       subtitle = paste("Total number of survey respondents (n =", total_sample, ")"),
       x = "",
       y = "Number of Responses") +
  theme_minimal() + 
...
print(q28_post_frequency_plot)
ggsave("plots/q28_post_frequency_plot.png", q28_post_frequency_plot)
```
...
q29_post_frequency_plot <- ggplot(as.data.frame(q29_frequency), aes(x = q29, y = Freq)) +
  geom_bar(stat = "identity", fill = "#041e42", width = 0.7) +
  coord_flip() +
  expand_limits(y = c(0, total_sample)) + 
  labs(title = "Q29. Which gender do you most closely identify with 
(or self-describe in 'other')?",
       subtitle = paste("Total number of survey respondents (n =", total_sample, ")"),
       x = "",
       y = "Number of Responses") +
  theme_minimal() + 
...
print(q29_post_frequency_plot)
ggsave("plots/q29_post_frequency_plot.png", q29_post_frequency_plot)
```
